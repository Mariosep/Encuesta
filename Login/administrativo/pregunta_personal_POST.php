          ...
          <div class="card-body">
              <?php
                  if (isset($añadir))
                  {
                    ...
                    $query="INSERT INTO preguntasus (id_preg_us, enunciado, op_respuesta) VALUES (NULL, '$enunciado', '$res_op');
                      ";
                     ...
                     mysqli_close ($mysqli);
                      ...
                      if(isset($eliminar)){
                          ...
                          $instruccion ="SELECT * FROM preguntasus where id_preg_us =\"$borrar[$i]\"";
                          ...
                          print ("<UL>\n");
                          print ("   <LI>Enunciado: " . $resultado['enunciado']);
                          print ("   <LI>Respuestas posibles: " . $resultado['op_respuesta']);
                          print ("<BR>");
                          print ("</UL>\n");

                          // Eliminar noticia
                          $instruccion = "DELETE FROM preguntasus where id_preg_us =\"$borrar[$i]\"";
